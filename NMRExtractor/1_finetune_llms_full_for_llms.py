...
new_model_dir = f"saved_models/Mistral-7B-Instruct-v0.2/split_train_{len(train_df)}_with_prompt_lr{learning_rate}_bs{per_device_train_batch_size}"  # Fine-tuned model name
